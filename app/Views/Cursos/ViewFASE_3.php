...
<header>
    <nav class="navbar navbar-expand-lg navbar-custom">
        <a class="navbar-brand"  id="sidebarToggle" href="ViewFASE_1.php">
    ...
    <main class="flex-grow-1 p-4 imagem">
            ...
            <div class="col-md-3 mb-4">
                    <div id="compras" class="card" onclick="redirectTo('../DIMENSAO/Dimensao_1_Relatorio.php')">
                        <img src="../../../public/IMG/relatorios.jpg"  class="card-img-top" alt="Dimensao1">
                        <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div id="compras" class="card" onclick="redirectTo('Dimensao_2.php')">
                        <img  src="../../../public/IMG/relatorios.jpg"  class="card-img-top" alt="Dimensao2">
                        <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div id="vendas" class="card" onclick="redirectTo('Dimensao_3.php')">
                        <img  src="../../../public/IMG/relatorios.jpg"  class="card-img-top" alt="Dimensao3">
                        <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div id="compras" class="card" onclick="redirectTo('Dimensao_4.php')">
                        <img  src="../../../public/IMG/relatorios.jpg"  class="card-img-top" alt="Dimensao4">
                        <div class="card-body">
                ...
                <div class="col-md-3 mb-4">
                    <div id="vendas" class="card" onclick="redirectTo('Dimensao_5.php')">
                        <img  src="../../../public/IMG/relatorios.jpg"  class="card-img-top" alt="Dimensão5">
                        <div class="card-body">
