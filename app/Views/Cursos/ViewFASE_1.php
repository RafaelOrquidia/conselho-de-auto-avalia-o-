...
<header>
    <nav class="navbar navbar-expand-lg navbar-custom">
        <a class="navbar-brand"  id="sidebarToggle" href="../Cnaq.php">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div id="vendas" class="card" data-bs-toggle="modal" data-bs-target="#optionsModal">
                    ...
                    <div class="card-body">
                        <h6 class="card-title">Eng.Agro Processamento</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="optionsModalLabel">Informe o Período</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <ul class="list-group">
                        <li class="list-group-item"><a href="ViewFASE_3.php">Laboral</a></li>
                        <li class="list-group-item"><a href="ViewFASE_3.php">Poslaboral</a></li>
                        <li class="list-group-item"><a href="ViewFASE_3.php">Curta Duração</a></li>
                    </ul>
                </div>
            </div>
        </div>
